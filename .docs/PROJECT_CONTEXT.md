...
Rule: business logic belongs in services. Views should handle request/response flow and delegate logic.
...
7. Scene unlocks, quest completion, XP, and scene item awards are applied.
...
- Services should return domain results/messages; view layer owns HTTP responses and page composition.

---

## Known Tech Debt (Current)
